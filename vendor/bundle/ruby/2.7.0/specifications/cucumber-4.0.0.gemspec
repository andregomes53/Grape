...
Gem::Specification.new do |s|
  ...
  s.summary = "cucumber-4.0.0".freeze
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<cucumber-gherkin>.freeze, [">= 13.0.0", "~> 13.0"])
    s.add_runtime_dependency(%q<cucumber-html-formatter>.freeze, ["~> 6.0", ">= 6.0.1"])
    s.add_runtime_dependency(%q<cucumber-messages>.freeze, ["~> 12.1", ">= 12.1.1"])
    s.add_runtime_dependency(%q<cucumber-wire>.freeze, [">= 3.0.0", "~> 3.0"])
    s.add_runtime_dependency(%q<diff-lcs>.freeze, [">= 1.3", "~> 1.3"])
    ...
    s.add_dependency(%q<cucumber-gherkin>.freeze, [">= 13.0.0", "~> 13.0"])
    s.add_dependency(%q<cucumber-html-formatter>.freeze, ["~> 6.0", ">= 6.0.1"])
    s.add_dependency(%q<cucumber-messages>.freeze, ["~> 12.1", ">= 12.1.1"])
    s.add_dependency(%q<cucumber-wire>.freeze, [">= 3.0.0", "~> 3.0"])
    s.add_dependency(%q<diff-lcs>.freeze, [">= 1.3", "~> 1.3"])
